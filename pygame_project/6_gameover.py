...
# Game Over (character hit by ball, fail)
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        for weapon_idx, weapon_val in enumerate(weapons):
            ...
            if weapon_rect.colliderect(ball_rect):
                ...
                # if not smallest, divide
                if ball_img_idx < 3:
                    # access current ball size
                    ...
                    balls.append({
                        ...
                        "to_x": -3,  # -3 left 3 right
                        "to_y": -6,  # y locatoin
                        "init_spd_y": ball_speed_y[ball_img_idx + 1]})  # initial y speed

                    # right bouncing small ball
                    balls.append({
                        # x of ball
                        "pos_x": ball_pos_x + (ball_width / 2) - (small_ball_width / 2),
                        # y of ball
            ...
            continue  # if inside forloop doesn't work, cont w/ outside forloop
        break  # inside forloop's break leads to here. exit both forloops
